...
SitesCache.java - Organize the sites that saved in the cache. Holds a Map for mapping each cached site to it CachedWebPage instance.
	...
	not bigger than the chosen maximum size.
